                  ...
                  <table className="w-full">
                    <thead className="dark:bg-gray-900 bg-gray-100">
                      <tr>
                        ...
                        <td className="text-xs font-semibold text-gray-800 dark:text-gray-100 pl-8 pr-4 uppercase">
                          <div className="flex items-center">
                            Shared Interests
                          </div>
                        </td>
                        <td className="text-xs font-semibold text-gray-800 dark:text-gray-100 pl-4 pr-8 uppercase">
                          <div className="flex items-center">
                            View Profile
                          </div>
                        </td>
      ...
      {(!loading) && (data) && (friends.length === 0) && (!modalIsOpen)
        ...
        <div className="top-20 bg-white rounded-2xl border-2 border-gray-200 flex flex-col justify-center items-center mx-auto p-10 w-full">
          <div className="flex flex-col justify-center items-center">
            ...
            <div className="max-w-3xl rounded overflow-x-auto">
              {'You haven\'t made any connections yet.'}
              <br />
              <br />
              Head over to Discover!
              <br />
              <br />
              <Link
                className="text-center bg-gray-800 rounded-full hover:bg-gray-600 py-4 px-16 block whitespace-no-wrap text-white font-bold uppercase"
                to="/discover"
              >
                Discover
              </Link>
